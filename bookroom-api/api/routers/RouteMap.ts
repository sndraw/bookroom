...
export default {
    ...
    AGENT_ALL: ROUTE_BASE_URL + "/agent",
    AGENT: ROUTE_BASE_URL + "/agent/platform/:platform",
    AGENT_DETAIL: ROUTE_BASE_URL + "/agent/platform/:platform/data/:agent_id",
    AGENT_STATUS: ROUTE_BASE_URL + "/agent/platform/:platform/data/:agent_id/status",
    AGENT_CHAT: ROUTE_BASE_URL + "/agent/platform/:platform/chat/:agent_id",
