...
export default {
    ...
    FILE: ROUTE_BASE_URL + "/file",
    FILE_DETAIL: ROUTE_BASE_URL + "/file/:object_id",
    ...
    AGENT_DETAIL: ROUTE_BASE_URL + "/agent/:agent_id",
    AGENT_STATUS: ROUTE_BASE_URL + "/agent/:agent_id/status",
    AGENT_CHAT: ROUTE_BASE_URL + "/agent/:agent_id/chat",
    ...
    PLATFORM_PARAMETERS: ROUTE_BASE_URL + "/platform/:platform/parameters",
